...
/**
 * The LongListAdapter is an implementation of the ListAdapter storing only primitive int data
 */
public class IntListAdapter extends ListAdapter implements java.io.Serializable {
    ...
    /** Creates a new instance of IntListAdapter with an empty internal int array*/
    public IntListAdapter() {
        super();
        list = new ArrayIntList();
    }
    
    /** Creates a new instance of IntListAdapter with an initial internal int array
     * @param data intial data to populate the internal int array
     */
    public IntListAdapter(int[] data) {
        super();
        list = new ArrayIntList(data);
    }
    ...
    public void add(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.add(index,((Integer)value).intValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    }
    ...
    public void set(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.set(index,((Integer)value).intValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    ...
    public void addAll(int index, ListAdapter list) throws UnsupportedOperationException,IllegalArgumentException {
        this.list.addAll(index, list.getIntList());
    }
    ...
    public ListAdapter subList(int fromIndex, int toIndex) {
        return new IntListAdapter(list.subList(fromIndex,toIndex).toArray());
    }
     ...
     */
    public Object clone() {
        IntListAdapter adapter = new IntListAdapter(list.toArray());
        return adapter;
    }
