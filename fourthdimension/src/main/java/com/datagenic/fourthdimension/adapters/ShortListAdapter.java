...
/**
 * The ShortListAdapter is an implementation of the ListAdapter storing only primitive short data
 */
public class ShortListAdapter extends ListAdapter implements java.io.Serializable {
    ...
    /** Creates a new instance of ShortListAdapter with an empty internal short array*/
    public ShortListAdapter() {
        super();
        list = new ArrayShortList();
    }
    
    /** Creates a new instance of ShortListAdapter with an initial internal short array
     * @param data intial data to populate the internal long array
     */
    public ShortListAdapter(short[] data) {
        super();
        list = new ArrayShortList(data);
    }
    ...
    public void add(Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.add(((Short)value).shortValue());
        } else {
    ...
    public void set(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            list.set(index,(short)0);
        } else if (value instanceof Number) {
            list.set(index,((Short)value).shortValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    ...
    public void addAll(int index, ListAdapter list) throws UnsupportedOperationException,IllegalArgumentException {
        this.list.addAll(index, list.getShortList());
    }
    ...
    public ListAdapter subList(int fromIndex, int toIndex) {
        return new ShortListAdapter(list.subList(fromIndex,toIndex).toArray());
    }
     ...
     */
    public Object clone() {
        ShortListAdapter adapter = new ShortListAdapter(list.toArray());
        return adapter;
    }
    ...
    public ListAdapter makeAdapter(int size) {
        ...
        return new ShortListAdapter(tmp);
    }    
}
