...
/**
 * The LongListAdapter is an implementation of the ListAdapter storing only primitive long data
 */
public class LongListAdapter extends ListAdapter implements java.io.Serializable {
    ...
    /** Creates a new instance of LongListAdapter with an empty internal long array*/
    public LongListAdapter() {
        super();
        list = new ArrayLongList();
    }
    
    /** Creates a new instance of LongListAdapter with an initial internal long array
     * @param data intial data to populate the internal long array
     */
    public LongListAdapter(long[] data) {
        super();
        list = new ArrayLongList(data);
    }
    ...
    public void add(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.add(index,((Long)value).longValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    }
    ...
    public void set(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.set(index,((Long)value).longValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    ...
    public void addAll(int index, ListAdapter list) throws UnsupportedOperationException,IllegalArgumentException {
        this.list.addAll(index, list.getLongList());
    }
    ...
    public ListAdapter subList(int fromIndex, int toIndex) {
        return new LongListAdapter(list.subList(fromIndex,toIndex).toArray());
    }
     ...
     */
    public Object clone() {
        LongListAdapter adapter = new LongListAdapter(list.toArray());
        return adapter;
    }
    ...
    public ListAdapter makeAdapter(int size) {
        ...
        return new LongListAdapter(tmp);
    }    
}
