...
public class FourthDimensionObject extends FourthDimensionValue 
{
   private Object value;
   
   /**
   @param value
   @roseuid 4226F0FD03B9
    */
   public FourthDimensionObject(Object value) 
   {
       this.value = value;    
   }
