...
/**
 * A LongSeries is used to store long data.  If you wish to store other datatypes consider using one of the
 * following series:<p>
 * 
 * FloatSeries<br>
 * LongSeries<br>
 ...
 * @see Series
 */
public class LongSeries extends NumericSeries
{
     ...
     */
   public LongSeries(String name, CalendarFrequency calendar)
   {
       super(name,calendar);
   }
   ...
   public Object clone()
   {
       LongSeries series = new LongSeries("Copy of " + this.getName(),this.getCalendar());
       ...
       series.listAdapter = ListAdapter.makeAdapter(listAdapter.toLongArray());
...
DataPointCollection LongSeries.getDataPointCollectionImpl(long,long){
