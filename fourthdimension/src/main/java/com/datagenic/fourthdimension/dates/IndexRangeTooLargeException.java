...
public class IndexRangeTooLargeException extends FourthDimensionRuntimeException {

	private static final long serialVersionUID = 6950028790750691167L;

	public IndexRangeTooLargeException(final String message) {

	}

	public IndexRangeTooLargeException() {
