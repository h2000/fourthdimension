...
public class DateHelper {
	 ...
	 */
	public static String getMonthName(final int javaCalendarMonth) {
	...
	public static int javaDayOfWeek(final int jodaDayOfWeek) {
	...
	public static String getDowName(final int javaDow) {
