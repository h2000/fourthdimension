...
public class Annual extends Monthly {
	...
	private static final long serialVersionUID = -1310895085065232026L;
	 ...
	 */
	public Annual(final int referenceMonth) {
...
/**
 * Annual.Annual(int,boolean[]){ super(DEFAULT_PERIODICITY,referenceMonth,pattern); }
 */
