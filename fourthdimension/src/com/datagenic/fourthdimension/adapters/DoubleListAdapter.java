...
/**
 * The DoubleListAdapter is an implementation of the ListAdapter storing only primitive double data
 */
public class DoubleListAdapter extends ListAdapter implements java.io.Serializable {
    ...
    /** Creates a new instance of DoubleListAdapter with an empty internal double array*/
    public DoubleListAdapter() {
        super();
        list = new ArrayDoubleList();
    }
    
    /** Creates a new instance of DoubleListAdapter with an initial internal double array
     * @param data intial data to populate the internal double array
     */
    public DoubleListAdapter(double[] data) {
        super();
        list = new ArrayDoubleList(data);
    }
    ...
    public void add(Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            ...
            list.add(((Double)value).doubleValue());
        } else {
    ...
    public void add(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            list.add(index,Double.NaN);
        } else if (value instanceof Number) {
            list.add(index,((Double)value).doubleValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    }
    ...
    public void set(int index, Object value) throws UnsupportedOperationException,IllegalArgumentException {
        if (value == null) {
            list.set(index,Double.NaN);
        } else if (value instanceof Number) {
            list.set(index,((Double)value).doubleValue());
        } else {
            throw new UnsupportedOperationException("Data type not supported. [" + value.getClass().getName());
        }
    ...
    public void addAll(int index, ListAdapter list) throws UnsupportedOperationException,IllegalArgumentException {
        this.list.addAll(index, list.getDoubleList());
    }
    ...
    public ListAdapter subList(int fromIndex, int toIndex) {
        return new DoubleListAdapter(list.subList(fromIndex,toIndex).toArray());
    }
     ...
     */
    public Object clone() {
        DoubleListAdapter adapter = new DoubleListAdapter(list.toArray());
        return adapter;
    }
    ...
    public ListAdapter makeAdapter(int size) {
        ...
        return new DoubleListAdapter(tmp);
    }
