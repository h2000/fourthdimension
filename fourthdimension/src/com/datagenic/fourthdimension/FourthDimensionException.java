...
public class FourthDimensionException extends Exception 
{
   
   /**
   @param message
   @roseuid 4151B28C035B
    */
   public FourthDimensionException(String message) 
   {
    super(message);    
   }
   
   /**
   @roseuid 4151A73D02EE
    */
   public FourthDimensionException() 
   {
    super();    
   }
}
