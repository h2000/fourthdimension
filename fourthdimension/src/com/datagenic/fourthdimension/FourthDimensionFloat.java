...
public class FourthDimensionFloat extends FourthDimensionNumber
{
   private float value;

   /**
   @param value
   @roseuid 4226F105003E
    */
   public FourthDimensionFloat(float value)
   {
       this.value = value;
   }
...
void FourthDimensionFloat.setValue(float){
      value = aValue;
   }
