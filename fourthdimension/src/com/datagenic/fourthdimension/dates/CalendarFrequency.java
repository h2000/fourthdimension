...
public abstract class CalendarFrequency implements Serializable 
{
   ...
   private VetoableChangeSupport vetoPropertyChangeSupport = new VetoableChangeSupport(this);
   ...
   @param aDateFormatter the new value of the dateFormatter property
    */
   ...
   Note.  The value returned in a Long value.
   ...
   <p>
   e.g in a Business frequency, if the index equivalent of Sunday was provided, it 
   will return the previous Friday.  If a Monday was specified, it will return the 
   Monday.
   ...
   Monday.
   <p>
   Note: Some frequencies may throw an UnsupportedOperationException in the event 
   they don't support this operation.
   @param index - The period index
   ...
   <p>
   e.g in a Business frequency, if the index equivalent of Sunday was provided, it 
   will return the following Monday.  If a Monday was specified, it will return 
   the Tuesday.
   ...
   /**
   Indicates whether the index period specified aligns to the calendar
   Note: Some frequency implementations may throw an UnsupportedOperationException 
    ...
    */
   public long[] getIndexes(Date startIndex, Date endIndex) throws IndexAlignmentException 
   {
       throw new UnsupportedOperationException("Calendar indexes are not supported for this frequency.");    
   }
   
   /**
   Indicates the number of periods at the calendar frequency which lie between the 
   start and end index. It is not inclusive of the end index.
   <p>
   Note: Some frequency implementations may throw an UnsupportedOperationException 
   in the event this operatrion is not applicable for the frequency.
   
   @param startIndex - The start index which is aligned to the calendar frequency
   @param endIndex - The end index which is aligned to the calendar frequency, 
   which designates the start of the next period.  Note the end index is not 
   excluded in the number of indexes.
   @return long
   @throws com.datagenic.fourthdimension.dates.IndexAlignmentException
   ...
   /**
   Specifies a boolean array that may be used in determining the periods of a 
   frequency.  This boolean array may optional be used by the implementing 
   calendar frequency.
   @param pattern - A pattern of boolean values indicating valid or invalid 
   periods.
   ...
   {       
       try {
           ...
           vetoPropertyChangeSupport.fireVetoableChange(TIMEZONE_PROPERTY,timezone,zone);
           timezone = zone;
